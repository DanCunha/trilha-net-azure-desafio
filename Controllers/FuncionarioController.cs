...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        funcionarioBanco.EmailProfissional = funcionarioBanco.EmailProfissional;
        funcionarioBanco.Departamento = funcionarioBanco.Departamento;
        funcionarioBanco.Salario = funcionarioBanco.Salario;
